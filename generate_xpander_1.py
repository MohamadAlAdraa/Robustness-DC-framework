...
params = [(32,256,23,8), (64,512,23,8)] #, (32,256,23,8),(64,512,23,8),(128,1024,23,8)
...
xpander_path_a = 'C:/Users/umroot/PycharmProjects/datacenter/new_xpander/d15/new/'
...
for p in params:
    ...
    # Xpander graph
    xpander_graph = get_the_best_xpander1(num_switches, num_servers, num_servers_per_rack, switch_d, 1000)
