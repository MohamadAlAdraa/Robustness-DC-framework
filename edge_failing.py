...
import random
from utilities import read_graph_from_file, find_average_shortest_path, plot_path_lengths, find_diameter, \
    find_laplacian_spectrum, find_adjacency_spectrum, find_betweenness_centrality, find_edge_betweenness_centrality, \
    find_std_av_shortest_path_length
import math
from collections import defaultdict
import json

params = [(512,4096,32,8)]
topos = ['xpander', 'jellyfish', 'strat']
f_p = 'C:/Users/umroot/PycharmProjects/datacenter/failing_figures/edge/edge_'
...
failure_rate = [0.02,0.04,0.06,0.08,0.1,0.12]
...
for p in params:
    ...
    for t in range(len(topos)):
        ...
        for r in failure_rate:
            number_of_edges_to_be_removed = math.floor(r*num_of_switches)
            av_sh = 0
            av_dm = 0
            ...
            for i in range(number_of_iterations):
                ...
                while(b):
                    ...
                    edges_to_be_removed = random.sample(G1.edges(), k=number_of_edges_to_be_removed)
